-- Kyle Dela Pena
-- Duration of employment of deceased employees
-- Report can be used for finding the correlation between deceased employees and their employee classifications
