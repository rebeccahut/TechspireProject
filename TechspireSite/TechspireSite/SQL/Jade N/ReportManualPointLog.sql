...
--Row Number, Employee First Name, Employee Lat Name, Customer First Name, Customer Last Name, Reason, Order Number, Order Date
...
WHERE PointReasonType.id <> 4 AND PointReasonType.id <> 5
