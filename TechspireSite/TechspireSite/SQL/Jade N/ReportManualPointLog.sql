...
--Displays only the employees who have manually inputted points as well as the customer details and order numbers that are associated with the manual input of points, specifically if it is not because of an order.
--Row Number, Employee First Name, Employee Lat Name, Customer First Name, Customer Last Name, Order Number, Order Date, Reason
