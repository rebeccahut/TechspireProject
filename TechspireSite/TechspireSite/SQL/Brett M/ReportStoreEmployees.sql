...
SELECT ROW_NUMBER() 
OVER(ORDER BY EmployeeType.id,Employee.first_name) AS num_row, EmployeeType.type_name, Employee.first_name, Employee.last_name, Employee.phone_number, Employee.email_address
FROM EmployeeJob
